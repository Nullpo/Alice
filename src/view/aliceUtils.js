...
define(function (require, exports) {
    ...
    exports.images = {
        protocols: {
            github: require.toUrl("images/github.png"),
            gitlab: require.toUrl("images/gitlab.png"),
            bitbucket: require.toUrl("images/bitbucket2.png")
        },
        priorities: {
...
Testing the *new comment* feature with preview <3
